...
| Interlock de motores | Activar simultáneamente motor de subida y motor de bajada | Q1 (motor subir), Q2 (motor bajar) | Se bloquea una de las salidas | El sistema impide que ambos motores se activen al mismo tiempo para evitar daños mecánicos o eléctricos en el actuador. |
